...
INSERT INTO workout_set (exercise, repetitions, body_part, weight, line_order, workout_id)
SELECT 'Wyciskanie sztangi', 8, 'chest', 80.0, 0, w.id
FROM workout w
...
INSERT INTO workout_set (exercise, repetitions, body_part, weight, line_order, workout_id)
SELECT 'Wiosłowanie hantlem', 10, 'back', 42.0, 1, w.id
FROM workout w
WHERE w.workout_date = DATE '2026-03-20'
